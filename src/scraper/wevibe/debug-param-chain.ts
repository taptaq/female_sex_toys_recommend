 ...
 *
 * 用法:
 *   npm run debug:param-chain:wevibe
 *   npm run debug:param-chain:wevibe -- "https://detail.tmall.com/item.htm?id=其它ID"
 *
...
/** 默认：We-Vibe 店铺页；调试参数链路时建议传入点击后得到的商品详情 URL */
const DEFAULT_URL =
  'https://wevibe.tmall.com/shop/view_shop.htm?appUid=RAzN8HWVJY3cGGRW7oQJ5Jen61ZqJNhhYB7arxnco2VeZeVeofh&spm=a21n57.1.hoverItem.1';
