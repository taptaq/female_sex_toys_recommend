 ...
 *
 * 用法:
 *   npm run debug:param-chain:iroha
 *   npm run debug:param-chain:iroha -- "https://detail.tmall.com/item.htm?id=其它ID"
 *
...
/** 默认：iroha 天猫商品详情（id=809826544996），可替换为其它店铺内详情页 URL */
const DEFAULT_URL =
  'https://detail.tmall.com/item.htm?id=809826544996&rn=e00435dbdbc0bccea9ea9b5fcc87d4be&abbucket=11';
