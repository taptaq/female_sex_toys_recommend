      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-300">
            这不只是再做一轮推荐，而是补充你长期更适合的节奏、隐私感和隐藏路线，帮你看清更稳定的装备路径。
          </p>
          {freeSummary ? (
            <div className="mt-3 rounded-2xl border border-white/8 bg-white/[0.045] px-3 py-3">
              <div className="flex items-center gap-2 text-cyan-100/84">
                ...
                <p className="text-[11px] tracking-wide">你的长期画像预告</p>
              </div>
        ...
        <div className="flex flex-col items-start gap-3 lg:items-end">
          ...
          >
            <span>{freeSummary ? "继续查看完整画像" : "开始查看长期画像"}</span>
            <ArrowRight className="h-4 w-4" />
          </button>
          <p className="text-xs leading-5 text-cyan-100/74">
            免费先看基础画像，完整报告 0.5 元解锁；它更像长期路线补充，不替代当前主推荐。
          </p>
        </div>
      </div>
    </section>
